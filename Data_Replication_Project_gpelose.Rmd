...
do things look different and change the results 
...
* Since the sample size is smaller than 30 should I be using gossets distribution 
* how do I get my excell file and pdf onto github so that others can use it!
* QUESTION# should I be using a gossets distribution?
* need to add photos of the graphs from paper 
